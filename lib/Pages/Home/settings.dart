...
class _SettingsPageState extends State<SettingsPage> {
  ...
  // Profile data
  Map<String, String> profile = {'name': '', 'position': 'Pediatrician'};
  void initState() {
    super.initState();
    _loadUserData();
  }
              ...
              : Padding(
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [
                                  BoxShadow(
                                    color:
                                        Colors.black26, // Color of the shadow
                              ...
                              child: ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  ...
                                  shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(
                                      8,
                                    ), // Matching the container's border radius
                    ...
                    const SizedBox(
                      height: 20,
                    ), // Spacer between Logout button and footer
                    // Footer
                    Center(
                      child: Text(
